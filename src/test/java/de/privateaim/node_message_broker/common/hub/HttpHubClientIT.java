...
public class HttpHubClientIT {
    ...
    void obtainingAnalysisNodesSucceedsOnFirstTry() throws JsonProcessingException {
        var node = new Node("test-node-id", "default", "not-relevant-here", "test-robot-id");
        ...
        StepVerifier.create(httpHubClient.fetchAnalysisNodes("test-analysis-id"))
    ...
    void obtainingAnalysisNodesSucceedsWithinRetryRange() throws JsonProcessingException, InterruptedException {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            assertEquals("test-analysis-id", requestUrl.queryParameter("filter[analysis_id]"));
    ...
    @Test
    void obtainingAnalysisNodesFailsAfterMaximumNumberOfRetriesOnServerError() throws JsonProcessingException, InterruptedException {
